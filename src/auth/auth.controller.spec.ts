...
describe('AuthController', () => {
  ...
  describe('register', () => {
    it('should throw BadRequestException when known error occurs', async () => {
      ...
      mockAuthService.register.mockRejectedValueOnce(new CustomAPIError('Email already in use'));
    ...
    it('should throw InternalServerErrorException when unknown error occurs', async () => {
      ...
      mockAuthService.register.mockRejectedValueOnce(new Error('Unknown Error'));
    ...
    it('should return UserDTO on successfull registration ', async () => {
      ...
      expect(mockAuthService.register).toHaveBeenCalledWith(signupData, RoleEnum.User)
    })
  });
  ...
  describe('createAuthor', () => {
    ...
    it('should return UserDTO on successfull registration ', async () => {
      ...
      expect(result).toEqual(userData);
      expect(mockAuthService.register).toHaveBeenCalledWith(signupData, RoleEnum.Author)
    })
  });
  ...
  describe('login', () => {
    it('should throw UnauthorizedException when user credentials are invalid', async () => {
      ...
      mockAuthService.login.mockRejectedValueOnce(new UnauthorizedException('Invalid user credentials'));
    ...
    it('should return accessToken and refreshToken on successful login', async () => {
      ...
      mockAuthService.login.mockResolvedValueOnce({ accessToken, refreshToken })
  ...
  describe('forgotPassword', () => {
    it('should throw BadRequestException when known error occurs', async () => {
      ...
      mockAuthService.forgotPassword.mockRejectedValueOnce(new CustomAPIError('Known Error'))
      try {
    ...
    it('should throw InternalServerErrorException when unknown error occurs', async () => {
      ...
      mockAuthService.forgotPassword.mockRejectedValueOnce(new Error('Unknown Error'));
      try {
        await controller.forgotPassword(passwordResetRequestData)
      } catch (error) {
        expect(error).toBeInstanceOf(InternalServerErrorException);
  ...
  describe('resetPassword', () => {
    it('should throw BadRequestException when known error occurs', async () => {
      ...
      mockAuthService.resetPassword.mockRejectedValueOnce(new CustomAPIError('Known Error'));
      try {
    ...
    it('should throw InternalServerErrorException when unknown error occurs', async () => {
      ...
      mockAuthService.resetPassword.mockRejectedValueOnce(new Error('Unknown Error'));
      try {
        await controller.resetPassword(passwordResetData)
      } catch (error) {
        expect(error).toBeInstanceOf(InternalServerErrorException);
  ...
  describe('refreshToken', () => {
    ...
    it('should throw InternalServerErrorException when accessTokeen creation fails', async () => {
      ...
      mockAuthService.accessToken.mockRejectedValueOnce(new Error('Unknow Error while creating access token'));
      try {
    ...
    it('should throw InternalServerErrorException when refreshToken creation fails', async () => {
      ...
      mockAuthService.refreshToken.mockRejectedValueOnce(new Error('Unknown Error while creating refresh token'));
    ...
    it('should return new access token and refresh token on successfull token refresh', async () => {
      ...
      mockAuthService.refreshToken.mockResolvedValueOnce({ token: refreshToken });
